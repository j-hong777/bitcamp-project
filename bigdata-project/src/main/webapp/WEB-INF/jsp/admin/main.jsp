													...
													<div class="tab-content padding-8">
														...
														<div id="member-tab" class="tab-pane">
															<div class="clearfix">
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Bob Doe's avatar" src="${pageContext.servletContext.contextPath}/images/avatars/user.jpg" />
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Alexa Doe's avatar" src="${pageContext.servletContext.contextPath}/images/avatars/avatar1.png" />
																	</div>
														...
														<div id="comment-tab" class="tab-pane">
															<div class="comments">
																...
																<div class="itemdiv commentdiv">
																	<div class="user">
																		<img alt="Jennifer's Avatar" src="${pageContext.servletContext.contextPath}/images/avatars/avatar1.png" />
																	</div>
											...
											<div class="widget-body">
												<div class="widget-main no-padding">
													<div class="dialogs">
														...
														<div class="itemdiv dialogdiv">
															<div class="user">
																<img alt="Bob's Avatar" src="${pageContext.servletContext.contextPath}/images/avatars/user.jpg" />
															</div>
				...
				<div class="footer-inner">
					<div class="footer-content">
						<span class="bigger-120">
							<span class="blue bolder">Bigdata3</span>
...
<![endif]-->
		...
		<script src="${pageContext.servletContext.contextPath}/assets/js/jquery.ui.touch-punch.min.js"></script>
